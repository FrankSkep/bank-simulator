...
public class AutenticarPanel extends javax.swing.JPanel {
    
    private Dashboard dashboard;
    
    public AutenticarPanel(Dashboard dashboard) {
    ...
    private void iniciarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniciarBtnActionPerformed
        ...
        char[] contraseña = passTF.getPassword();
        
        UsuarioDAO db = new UsuarioDAO();
        Usuario usuario = db.autenticar(nombreUsuario, String.valueOf(contraseña));
        ...
        if (usuario != null) {
            ...
            Tools.showPanel(new InicioPanel(), (JPanel) this.getParent());
        } else {
